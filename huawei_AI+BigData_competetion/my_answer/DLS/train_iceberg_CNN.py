...
data_path = 's3://obs-b666/iceberg_demo/iceberg_data/train.json'
data_buf = mox.file.read(data_path, binary=True)
df_train = pd.read_json(data_buf)
...
data_path = 's3://obs-b666/iceberg_demo/iceberg_data/test.json'
data_buff = mox.file.read(data_path, binary=True)
df_test = pd.read_json(data_buff)
